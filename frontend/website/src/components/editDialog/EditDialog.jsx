...
const EditDialog = (props) => {
  ...
  const handleConfirm = () => {
    EditAppliance(editApplianceCallback,failEditApplianceCallback,applianceToAdd)
  }
  return (
    <div>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        <DialogActions>
          ...
          <Button onClick={handleConfirm} variant="contained" color="primary" disabled={disableButton}>
            Confirm
          </Button>
        </DialogActions>
      </Dialog>
