...
describe("Render tests for EditDialog", () => {
  ...
  test("Checking Serial Number field", () => {
    ...
    expect(component.find("#serialNumber").props().defaultValue).toEqual(
  ...
  test("Checking Brand field", () => {
    ...
    expect(component.find("#brand").props().defaultValue).toEqual(
      selectedAppliance["Brand"]
    );
  });
  test("Checking Model field", () => {
    ...
    expect(component.find("#model").props().defaultValue).toEqual(
  ...
  test("Checking Status field", () => {
    ...
    expect(component.find("#status").props().defaultValue).toEqual(
  ...
  test("Date Bought field", () => {
    ...
    expect(component.find("#dateBought").props().defaultValue).toEqual(
      selectedAppliance["DateBought"]
    );
  });
});
