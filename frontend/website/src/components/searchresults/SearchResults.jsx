          ...
          <Grid key={result.Brand} item xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="subtitle2">Serial Number: {result.SerialNumber}</Typography>
                <Typography variant="subtitle2">Date Bought: {result.DateBought}</Typography>
                <Typography variant="subtitle2">Updated At: {result.CreatedAt}</Typography>
              </CardContent>
            </Card>
          </Grid>
        )
