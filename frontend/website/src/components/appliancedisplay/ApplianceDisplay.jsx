          ...
          <Grid item key={appliance.ID} xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="subtitle2">SerialNumber: {appliance.SerialNumber}</Typography>
                <Typography variant="subtitle2">Date Bought: {appliance.DateBought}</Typography>
                <Typography variant="subtitle2">Updated At: {appliance.CreatedAt}</Typography>
              </CardContent>
              <Grid container style={{paddingLeft:'1%',paddingBottom:'2%'}}spacing={3} justify="space-between">
                <Grid item xs={3}>
